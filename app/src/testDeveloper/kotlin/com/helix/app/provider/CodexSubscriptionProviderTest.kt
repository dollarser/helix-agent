...
class CodexSubscriptionProviderTest {
    @Test fun successEventsPassThroughUnchanged() = runBlocking {
    ...
    @Test fun failedAndTimedOutJobsBecomeTotalErrorStreams() = runBlocking {
    ...
    @Test fun collectionCancellationReachesTheJobExecutor() = runBlocking {
        var cancelled = false
    ...
    private fun terminal(state: CliModelJobState, events: List<ModelEvent>? = null): CliModelJobClient.AwaitOutcome.Terminal =
