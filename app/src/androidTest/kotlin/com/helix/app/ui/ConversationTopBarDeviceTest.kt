...
class ConversationTopBarDeviceTest {
    ...
    @Test fun conversationOwnsTheTopAndNavigationRemainsReachable() {
        ...
        captureChatLayout(compose.activity, "refactor-conversation")
        compose.onNodeWithTag("chat-conversation-details").performClick()
        compose.onNodeWithTag("chat-conversation-details-sheet").assertIsDisplayed()
        compose.waitForIdle()
        captureChatLayout(compose.activity, "refactor-session-sheet")
        ...
        compose.onNodeWithTag("chat-composer-options-sheet").assertIsDisplayed()
        compose.waitForIdle()
        captureChatLayout(compose.activity, "refactor-composer-sheet")
