"""Verify dynamic reasoning menus and transcript-only copy actions in a fresh consumer sandbox."""
import argparse
import hashlib
import json
import os
...
classes = ['ConversationComposerDeviceTest', 'MessageCopyDeviceTest']
...
try:
    ...
    device('shell', 'am', 'start', '-W', '-n', 'com.helix.agent/com.helix.app.MainActivity')
