...
for api in 29 36; do
  python3 scripts/debug/2026-09-09/run-owned-emulator.py \
    ...
    --classes com.helix.app.proot.ProotJobE2eDeviceTest,com.helix.app.proot.ProotDetachedJobDeviceTest,com.helix.app.proot.DetachedJobControlDeviceTest,com.helix.app.proot.DetachedJobLaunchDeviceTest \
