#!/usr/bin/env python3
"""Run HXA-214 core receipts, draft storage, stop and Goal regression on four owned API/flavor instances.
...
def main():
    ...
    classes = ["com.helix.app.chat.ChatServiceAttachmentRetryDeviceTest",
