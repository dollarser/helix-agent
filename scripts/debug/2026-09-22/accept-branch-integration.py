#!/usr/bin/env python3
"""Run merged marketplace, Connector, session fork, compaction and Goal regression on four owned API/flavor instances.
...
def main():
    ...
    classes = ["com.helix.app.marketplace.MarketplaceDeviceTest",
