...
s=p.read_text().replace('Parks a RUNNING goal in PAUSED and closes its open runs (ADR-GOAL-001: the checkpoint is kept', 'Parks a RUNNING goal in PAUSED, or BLOCKED for unresolved effects/budget, and closes runs.\n     * ADR-GOAL-001/0039: the checkpoint is kept')
p.write_text(s)
