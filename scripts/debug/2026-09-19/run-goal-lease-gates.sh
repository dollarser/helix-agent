...
for api in 29 36; do
  for flavor in consumer developer; do
    ...
    python3 scripts/debug/2026-09-09/run-owned-emulator.py \
      ...
      --classes com.helix.app.chat.GoalDetachedBudgetDeviceTest,com.helix.app.chat.GoalLeaseClockDeviceTest,com.helix.app.chat.GoalTimeLeaseDeviceTest,com.helix.app.chat.GoalUsageReservationsDeviceTest,com.helix.app.chat.GoalRunCoordinatorDeviceTest,com.helix.app.chat.GoalModelReportDeviceTest \
