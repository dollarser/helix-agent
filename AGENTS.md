...
- Create a persistent development Goal only when the user explicitly requests one. Derive its objective and checkpoints from the authorized scope, `docs/implementation-status.md`, and the roadmap; do not hard-code historical milestone state.
