...
当前专项验证命令仍以 [verification-matrix.md](verification-matrix.md) 的 M7 表为准。HXA-070～079 已逐项完成当前任务要求的 JVM/构建或 API 29/36 功能级设备链路，M7 在该范围内完成；M12 的物理真机、真实外部服务/网络、签名产物与完整 SBOM/notice 仍是明确发布门禁，不能由模拟器证据代替。
