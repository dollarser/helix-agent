...
- **后续计划已就绪：[198](tasks/HXA-198.md)／[199](tasks/HXA-199.md)／[206](tasks/HXA-206.md)，本轮不直接实施**；191、197、211 已交付，196 真机验收按所有者指示本次跳过，未计通过。193、195、204、205 均已交付，各任务证据与范围见完成记录。
