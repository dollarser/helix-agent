...
- **后续计划推进：[198](../completion-records/HXA-198.md) 已交付，[199](tasks/HXA-199.md)／[206](tasks/HXA-206.md) 准备就绪**；191、197、198、211 已交付，196 真机验收按所有者指示本次跳过，未计通过。193、195、198、204、205 均已交付，各任务证据与范围见完成记录。
...
2026-09-20 所有者明确要求跳过本次 196 真机 HOME／锁屏／Doze 验收，继续整合当前分支到 main、推送并验证远端 CI。该豁免解除本次交付阻塞，不是物理设备验收通过；保留 HXA-196 的未验证边界，198／199／206 仍只有计划。
