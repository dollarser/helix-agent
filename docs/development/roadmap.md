...
对话线剩余顺序 **214 UI收口 → 216 → 217**；215最新消息会话内修订已独立交付。按最新收敛安排，214/215联合整合与main CI之后先推进216，再推进接受后的129（安全替换与会话启停），详见[工作计划](next-work-plan.md)。214 核心已获实施授权，见[核心交接](hxa-214-core-handoff.md)；215按所有者新指令完成最新消息会话内修订（009已接受），尚未合入main；216/217未启动。
