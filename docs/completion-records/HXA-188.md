...
决策记录：沿用 ADR-RUNTIME-004、ADR-PERMISSIONS-003 与 ADR-GOAL-001；本次修复回调调度/连接身份与测试宿主，不改变 Root 权限、IPC、依赖或后台/Goal 契约，无需新增 ADR。Root 长期不变式见 [Bug 修复记录](../bug-fixes/2026-09-10-root-service-death-callback-reentrancy.md)。
