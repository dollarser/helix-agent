...
| --- | --- | ---: | ---: |
| API29 | app | 163 | 0 |
| API29 | core-storage | 50 | 0 |
| API29 | feature-files | 38 | 0 |
| API29 | feature-browser | 36 | 2 |
| API29 | runtime-quickjs | 75 | 0 |
| API29 | tools-android | 30 | 0 |
| API29 | tools-automation | 1 | 0 |
| API29 | automation-force-stop-recovery | 1 | 0 |
| API36 | app | 163 | 0 |
| API36 | core-storage | 50 | 0 |
| API36 | feature-files | 38 | 0 |
| API36 | feature-browser | 36 | 2 |
| API36 | runtime-quickjs | 75 | 0 |
| API36 | tools-android | 30 | 0 |
| API36 | tools-automation | 1 | 0 |
| API36 | automation-force-stop-recovery | 1 | 0 |
