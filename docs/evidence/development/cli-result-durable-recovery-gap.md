...
The existing transaction couples reading bytes to acknowledging their durable receipt. Runtime transport completion is used as a substitute for the main App's persistence confirmation required by ADR-RUNTIME-001.
...
- [Runtime lifecycle decision](../../adr/runtime/001-execution-domains.md)
