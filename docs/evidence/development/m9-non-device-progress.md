...
快照时间：2026-09-05。后续2026-09-10真机授权/拒绝/服务死亡与有界读取证据见 [HXA-188](../../completion-records/HXA-188.md)；下表保留原非真机交付边界，不作为当前尚无真机证据的声明。
...
| 094 | libsu 6.0.0 `core`/`service`、JitPack exclusive content、checksum/notice/lock、accepted ADR-RUNTIME-004、rootless 双 AVD 与物理设备脚本已完成 | 专用 rooted 物理设备上的拒绝、授权、撤销/失权与 RootService crash 尚未执行；不得写完成记录 |
