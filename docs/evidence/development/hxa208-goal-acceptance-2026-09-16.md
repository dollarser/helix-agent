...
基线：2026-09-16 `main` 的 `bcc2a6dc` 加本任务改动。决策见 [ADR-GOAL-001](../../adr/goal/001-lifecycle-and-completion.md)。状态：本任务范围验收通过，见[完成记录](../../completion-records/HXA-208.md)。工作区另有独立审批 ADR 草案，仅保留，不纳入 Goal 提交。
