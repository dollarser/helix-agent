...
2026-09-16 增量：[ADR-0053](0053-goal-continuation-activation.md) 定义原文所要求的独立激活与轮次准入，并经所有者授权实现前后台连续 Goal。本文“不增加自动续跑”仅描述当时增量；BLOCKED 复查与暂停语义保留，模型完成报告已由 ADR-0040 取代旧证据约束。
