 ...
 * repository reads the current row first and passes the advanced revision inside the caller's
 * transaction). Reset stores a fixed copy of the current default.
 */
@Dao
