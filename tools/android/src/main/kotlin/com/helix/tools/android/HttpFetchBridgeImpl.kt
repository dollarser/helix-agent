...
class HttpFetchBridgeImpl(
    ...
    private fun doHttpRequest(
        ...
        endpoint: NormalizedEndpoint,
        request: HttpFetchRequest,
    ): HttpFetchResponseParser.ParsedResponse {
        ...
        return HttpFetchResponseParser.read(secure.getInputStream(), request)
    }
    ...
    private fun fetched(
        response: HttpFetchResponseParser.ParsedResponse,
        finalUrl: String,
        redirectCount: Int,
    ): HttpFetchOutcome =
        HttpFetchOutcome(
    ...
    private sealed interface Conn {
        data class Ok(
            val response: HttpFetchResponseParser.ParsedResponse,
        ) : Conn
