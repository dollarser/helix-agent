...
- [总体架构](docs/architecture/overview.md)与[安全和发布门禁](docs/security/testing-and-release.md)：规范性设计与不可绕过边界。
...
- 远程 Worker、云端沙箱、桌面配对、HarmonyOS、自动支付和无人确认的对外发送不在当前范围；Tasker/Auto.js 与 Shizuku/ADB 仅是未排期研究候选。
